...
<footer class="w-full bg-surface py-16 px-6 lg:px-12 border-t border-outline-variant/20 relative z-20 transition-all">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div class="md:col-span-4 space-y-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="mailto:contact@wilsolvewel.com" class="w-9 h-9 rounded-lg border border-outline-variant flex items-center justify-center text-on-surface-variant hover:bg-primary hover:text-on-primary transition-all group">
        ...
        <div class="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <a class="text-on-surface-variant hover:text-on-surface transition-colors text-[11px] font-bold uppercase tracking-widest" href="${rootPath}about.php">About Us</a>
                    <a class="text-on-surface-variant hover:text-on-surface transition-colors text-[11px] font-bold uppercase tracking-widest" href="${rootPath}career.php">Careers</a>
                    <a class="text-on-surface-variant hover:text-on-surface transition-colors text-[11px] font-bold uppercase tracking-widest" href="${rootPath}faq.php">FAQ</a>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto mt-16 pt-8 border-t border-outline-variant/10 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="font-body text-[10px] text-on-surface-variant/60 uppercase tracking-widest">© 2024 Wilsolvewel Engineering. Precision Industrial Support.</p>
